...
public class Principal {
    ...
    private final String API_KEY = "&apikey=526600ac";
...
//        }
//
//        System.out.println("A partir de que ano deseja exibir os episodios? ");
...
//                ));
        Map<Integer,Double> avaliacaoTemporada = episodios
                .stream()
